 ...
 * @author Freedom0013
 */
public class ExaminationActivity extends BaseActivity implements StudyTreeTitleBar.TitleBarClickListener {
    ...
    private void initView() {
        ...
        //配置toolBar
        StudyTreeTitleBar examination_tool = findViewById(R.id.examination_tool);
