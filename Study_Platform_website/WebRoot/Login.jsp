						...
						<div id="login" class="animate form">
							<form action="mysuperscript.php" autocomplete="on">
								...
								<p>
									...
									<input id="username" name="username" required type="text" placeholder="账号" />
								</p>
								<p>
							...
							<form action="mysuperscript.php" autocomplete="on">
								...
								<p>
									<label for="emailsignup" class="youmail" data-icon="e">
										你的邮箱</label> <input id="emailsignup" name="emailsignup" required
								...
								<p>
									<label for="passwordsignup_confirm" class="youpasswd"
										data-icon="p">确认你的密码</label> <input id="passwordsignup_confirm"
